    ...
    <>
      ...
      <main>
        ...
        <div ref={slideRef} className="w-full select-none">
          ...
          <div className="absolute top-[18%] sm:top-1/4 flex w-full justify-between items-center">
            {/*<div className=" md:p-10 w-1/3 h-1/2 md:h-1/4">*/}
            <div className="bg-transparent backdrop-blur-sm md:p-10 w-1/3 h-[40%] sm:h-1/2 md:h-1/4">
              <h1 className="text-white font-bold text-sm sm:text-md md:text-4xl">
                <Typewriter
                  words={[
                    "Welcome to the",
