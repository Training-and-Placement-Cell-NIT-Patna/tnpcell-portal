    ...
    <div className="bg-[#510505] text-stone-400">
      <div className="grid grid-cols-2 md:grid-cols-6 ">
        ...
        <div className="p-4">
          ...
          <ul>
            <li className={"py-1"}>
              ...
              <li className={"py-1"}>
              <Link href="https://drive.google.com/file/d/1EdgaqKGB0zlB1LUmypjpnV9QAkXmpjBu/view" >
                <a target={"_tnp"} >Sexual Harassment of Women at Work place</a>
              </Link>
            </li>
        ...
        <div className="p-4">
          ...
          <ul>
            <li className={"py-1"}>
              <Link href="https://www.nitp.ac.in/magazine">
                <a target={"_tnp"}>  Magazine (Vol.4)</a>
              </Link>
            </li>
            <li className={"py-1"}>
            ...
            <li className={"py-1"}>
              <Link href="https://www.nitp.ac.in/sitemap">
                <a target={"_tnp"}>  Site Map</a>
              </Link>
            </li>
          </ul>
        </div>
        <div className="p-4">
          ...
          <ul>
            ...
            <li className={"py-1"}>
              <Link href="https://www.nitp.ac.in/tenders">
                <a target={"_tnp"}>
                  Tenders
                </a>
                </Link>
