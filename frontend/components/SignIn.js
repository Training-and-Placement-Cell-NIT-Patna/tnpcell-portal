          ...
          <div className="py-8 mt-5 shadow sm:rounded-lg sm:px-10 g-blur-md h-[35rem] p-7 glass">
            ...
            >
              ...
              <div>
                ...
                >
                  {loading && (<>
                    <svg aria-hidden="true" role="status" className="inline w-4 h-4 mt-1 mx-3 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
